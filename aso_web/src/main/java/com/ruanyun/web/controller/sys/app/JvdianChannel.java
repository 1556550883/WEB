...
public class JvdianChannel extends BaseChannel 
{
	private static final Log log = LogFactory.getLog(JvdianChannel.class);
	//我们的渠道号
	private static final String cuid = "551";

	//排重+点击+云聚
	public static AppCommonModel isJvdianChannel(TChannelAdverInfo adverInfo, String adid, String idfa, String ip,
