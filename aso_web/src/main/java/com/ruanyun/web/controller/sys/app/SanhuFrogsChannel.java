...
import net.sf.json.JSONObject;
	...
	public class SanhuFrogsChannel  extends BaseChannel 
	{
		private static final Log log = LogFactory.getLog(SanhuFrogsChannel.class);
		
		//我们的渠道号
		private static final String source = "happyzhuan";
		private static final String source_key = "e98660a72592cdc31d8dec9b1e63b7a1";
