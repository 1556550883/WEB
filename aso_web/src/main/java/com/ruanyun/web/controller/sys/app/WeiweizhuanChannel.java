...
public class WeiweizhuanChannel extends BaseChannel 
{
	private static final Log log = LogFactory.getLog(WeiweizhuanChannel.class);
	
	//我们的渠道号
	private static final String source = "qswl";
	//排重+点击+云聚
	public static AppCommonModel isWeiweizhuanChannel(TChannelAdverInfo adverInfo, String adid, String idfa, String ip,
	...
	public static AppCommonModel dianJi(String domain, String adid, String idfa, String ip,
		...
		{
			log.error("request url：" + url + "。response：" + jsonObject.toString());
			String code = (String)jsonObject.get("success");
			if(code!= null && code.equalsIgnoreCase("true"))
			{
				model.setResult(1);
				model.setMsg("领取任务成功！");
			}
